...
import com.jaron.common.to.MemberPrice;
...
public class SkuFullReductionServiceImpl extends ServiceImpl<SkuFullReductionDao, SkuFullReductionEntity> implements SkuFullReductionService {
    ...
    public void saveSkuReduction(SkuReductionTo reductionTo) {
        ...
        skuLadderEntity.setFullCount(reductionTo.getFullCount()); // 满几件 默认3件
        skuLadderEntity.setDiscount(reductionTo.getDiscount()); // 打几折
        skuLadderEntity.setAddOther(reductionTo.getCountStatus()); // 是否可以叠加其他优惠 1可叠加 0不可
