...
import com.jaron.common.to.SpuBoundTo;
...
import com.jaron.joomall.product.dao.SpuInfoDao;
import com.jaron.joomall.product.entity.*;
import com.jaron.joomall.product.feign.CouponFeignService;
import com.jaron.joomall.product.feign.SearchFeignService;
import com.jaron.joomall.product.feign.WareFeignService;
import com.jaron.joomall.product.service.*;
import com.jaron.joomall.product.vo.*;
...
public class SpuInfoServiceImpl extends ServiceImpl<SpuInfoDao, SpuInfoEntity> implements SpuInfoService {
    ...
    public void up(Long spuId) {
        ...
        List<SkuEsModel.Attrs> attrs = baseAttrs.stream()
                .filter(item -> isSet.contains(item.getAttrId())).map(item -> {
